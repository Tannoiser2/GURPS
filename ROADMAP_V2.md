...
- [ ] **L1 — Prompt caching** `claude_service.py`
...
- [ ] **L2 — Context compression per sessioni lunghe** `claude_service.py`
...
- [ ] **L3 — Model routing intelligente** `claude_service.py`
...
- [ ] **L4 — Retry robusto con fallback graduato** `claude_service.py`
...
- [ ] **L5 — Deadlock guard con context ricco** `deadlock_guard.py`
...
- [ ] **N1 — Canonical event log** `adventure_runtime_store.py` / `models.py`
...
- [ ] **N2 — NPC voice consistency** `narrative_director.py`
...
- [ ] **N3 — Tone register per genere** `genre_constraints.py` / `claude_service.py`
...
- [ ] **N4 — Revelation pacing control** `revelation_controller.py` / `world_simulator.py`
...
- [ ] **N5 — Witness protection come meccanica esplicita** `world_simulator.py` / `main.py`
...
- [ ] **N6 — Multi-session continuity** `adventure_runtime_store.py`
...
- [ ] **N7 — Red herring gameplay attivo** `world_simulator.py`
...
- [ ] **N8 — Finale condition check esplicito** `narrative_director.py`
...
- [ ] **R1 — Client state sync con diff semantici** `main.py`
...
- [ ] **R2 — Session recovery dopo crash** `adventure_runtime_store.py`
...
- [ ] **R3 — main.py refactoring in router** `main.py`
...
- [ ] **R4 — Token budget tracking per sessione** `claude_service.py`
...
- [ ] **R5 — Hardcoded threshold review** `world_simulator.py` / `clock_engine.py`
...
- [ ] **U1 — Clock visualization** `App.jsx`
...
- [ ] **G3 — Injury e recovery system** `combat.py` / `models.py`
...
- [ ] **A1 — Template library avventure** `adventure_compiler.py` / `main.py`
...
- [ ] **A2 — Adventure doctor migliorato** `adventure_doctor.py`
...
- [ ] **A3 — Raw text adventure mode migliorato** `adventure_compiler.py`
...
- [ ] **T1 — Integration test full game loop** `tests/`
...
- [ ] **T2 — NPC pressure event tests** `tests/test_npc_pressure.py`
...
- [ ] **T3 — World simulator unit tests** `tests/test_world_simulator.py`
...
- [ ] **T4 — Escalation limiter edge cases** `tests/test_escalation.py`
...
- [ ] **T5 — Equipment coherence** `tests/test_equipment_coherence.py`
...
- [ ] **T6 — Character creation end-to-end** `tests/test_character_creation.py`
...
- [ ] **T7 — Canonical event log coerenza** (post-N1)
