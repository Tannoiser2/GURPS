...
class SceneEntity(BaseModel):
    ...
    # ── Stato transitorio manovra (durata: fino al prossimo turno dell'NPC) ───
    defense_bonus: int = 0              # +2 se ha scelto Difesa Totale
    no_active_defense: bool = False     # True se ha scelto Attacco Totale (nessuna difesa)
